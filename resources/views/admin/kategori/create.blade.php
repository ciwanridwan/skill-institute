@extends('layouts.app', ['activePage' => 'create-kategori', 'title' => 'Kategori Training', 'navName' => 'Kategori Training', 'activeButton' => 'create-kategori'])
                            ...
                            <form method="post" action="{{ route('store-kategori') }}" autocomplete="off"
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nama" id="input-nama" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" placeholder="{{ __('Nama Kategori') }}" value="" required autofocus>
