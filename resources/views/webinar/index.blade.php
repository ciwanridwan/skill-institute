                ...
                <div class="container-fluid">
                    <div class="menu-wrapper">
                        ...
                        <div class="logo">
                            ...
                            <a href="index.html">Skill Institute</a>
                        </div>
                        <!-- Main-menu -->
                            ...
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li class="hot"><a href="#">Pelatihan</a>
                                        <ul class="submenu">
                                            <li><a href="shop.html">Pelatihan online</a></li>
                                            <li><a href="shop.html"> Pelatihan offline</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-popular-items mb-50 text-center">
                                    <div class="popular-img">
                                        <img src="assets/img/gallery/product2.jpeg" alt="">
                                        <div class="img-cap">
                                            <span>Tambah</span>
                                        </div>
                                        <div class="favorit-items">
                    ...
                    <div class="col-xl-7 col-lg-8 col-md-7">
                        <div class="footer-copy-right">
                            <p>
                                ...
                                </script><i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Skill Institute</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
                    </div>
